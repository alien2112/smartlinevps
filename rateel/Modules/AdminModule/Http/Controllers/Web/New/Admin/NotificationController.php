...
class NotificationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $notifications = $notifications->where('sent_to', 'customer')->latest()->paginate(10)->appends($query_param);
    ...
    public function store(Request $request)
    {
        ...
        // $product_slug = Product::where('id' , $request->product)
        // ->value('slug');
        // dd($product_slug);
        // $notification->product_slug = $product_slug;
        // $notification->product_id = $request->product ;

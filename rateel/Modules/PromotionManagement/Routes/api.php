...
use Modules\PromotionManagement\Http\Controllers\Api\New\Driver\BannerSetupController as BannerSetupDriver ;
...
Route::group(['prefix' => 'driver'], function (){
    ...
    Route::group(['prefix' => 'banner'], function(){
        Route::controller(BannerSetupDriver::class)->group(function () {
            Route::get('list', 'list');
        Route::post('update-redirection-count', 'RedirectionCount');
        });

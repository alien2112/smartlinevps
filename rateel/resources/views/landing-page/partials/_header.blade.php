        ...
        <div class="container">
            <div class="navbar-bottom-wrapper">
                <a href="{{route('index')}}" class="logo">
                    @if($logo)
                        <img src="{{ asset("storage/app/public/business/".$logo) }}" alt="Smart Line Logo" style="max-height: 50px;" onerror="this.onerror=null; this.src='{{ asset('logo-smart.jfif') }}';">
                    @else
                        <img src="{{ asset('logo-smart.jfif') }}" alt="Smart Line Logo" style="max-height: 50px;" onerror="this.onerror=null; this.src='{{ asset('landing-page/assets/img/smartline-logo.svg') }}'; this.style.display='none'; this.nextElementSibling.style.display='inline';">

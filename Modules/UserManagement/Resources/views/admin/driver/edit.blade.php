                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-4">
                                            ...
                                            <select name="gender" id="gender" class="form-control text-capitalize" required>
                                                <option disabled {{ !$driver->gender ? 'selected' : '' }}>-- {{ translate('select_gender') }} --</option>
                                                <option value="male" {{ $driver->gender == 'male' ? 'selected' : '' }}>{{ translate('male') }}</option>
                                ...
                                <div class="d-flex flex-column align-items-center gap-4">
                                    ...
                                    <div class="position-relative text-center">
                                        <div class="upload-file auto">
                                            ...
                                            <div class="upload-file__img border-gray d-flex justify-content-center align-items-center"
                                                 style="width: 220px; height: 220px; border-radius: 10px; overflow: hidden;">
                                                <img class="upload-file__img__img w-100 h-100 object-fit-cover"
                                                     loading="lazy"
                                                     src="{{ onErrorImage(
                                        ...
                                        <!--<button type="button" class="btn btn-outline-primary mt-2 d-flex align-items-center gap-2">-->
                                        <!--    <img src="{{ asset('public/assets/admin-module/img/svg/edit-circle.svg') }}" alt="Edit" class="svg">-->
                                        <!--    {{ translate('Edit Image') }}-->
                                        <!--</button>-->
                                    </div>
                                    <p class="opacity-75 text-center mt-2">{{ translate('JPG, JPEG, PNG, WEBP Less Than 1MB') }}</p>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="d-flex flex-column gap-4">
                                            <h5>{{ translate('identity_card_images') }}</h5>
                                            <div class="d-flex flex-wrap gap-3">
                                                @if ($driver?->identification_image)
                                                    @foreach ($driver?->identification_image as $img)
                                                        <div class="upload-file__img upload-file__img_banner"
                                                             style="width: 150px; height: 150px; border-radius: 8px; overflow: hidden;">

                            ...
                            <div class="row align-items-center mb-4 ">
                                <div class="col-sm-6 col-xl-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="is_marketer" name="is_marketer" value="1" {{ $coupon->is_marketer ? 'checked' : '' }}>
                                        <label class="form-check-label" for="is_marketer">
                                            {{ translate('is_marketer_coupon') }}
                                        </label>
                                        <i class="bi bi-info-circle-fill text-primary cursor-pointer" data-bs-toggle="tooltip"
                                           title="{{ translate('check_if_this_coupon_is_for_marketers') }}"></i>
                                    </div>
                                </div>
                            </div>

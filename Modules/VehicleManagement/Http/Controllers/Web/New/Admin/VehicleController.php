...
class VehicleController extends BaseController
{
    ...
    public function create(): Renderable
    {
        ...
        return view('vehiclemanagement::admin.vehicle.create',compact('years'));
    }
    ...
    public function edit(string $id): Renderable
    {
        ...
        $vehicle = $this->vehicleService->findOne(id: $id, relations: $relations);
        $years = VehicleYear::all();
         $categories = VehicleCategory::where('is_active', 1)->get();
        return view('vehiclemanagement::admin.vehicle.edit', compact('vehicle','years','categories'));
    }

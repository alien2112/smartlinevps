                                        ...
                                        <div class="d-flex flex-column align-items-start gap-1">
                                            ...
                                            <div class="row g-2 w-100">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    {{ implode('، ', $vehicle->category_names) }}
                                                </span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="d-flex flex-wrap align-items-center gap-2">
                                                        <span class="text-muted">{{ translate('year') }} -
                                                        </span><span
                                                            class="text-dark">{{$vehicle?->vehicleYear?->year}}</span>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="d-flex flex-wrap align-items-center gap-2">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-borderX-0 p-lg">
                            ...
                            <tr>
                                <td>{{ translate('licence') }}</td>
                                <td>{{ $vehicle->licence_plate_number . $vehicle->licence_plate_char }}</td>

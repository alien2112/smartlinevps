                    ...
                    @forelse ($categories as $category)
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h3 class="fs-27">{{ $category->vehicless->count() }}</h3>
                                        ...
                                        <table class="table table-borderless align-middle">
                                            <thead class="table-light align-middle">
                                                <tr>
                                                    ...
                                                    <th class="text-capitalize total-vehicle brand-model">
                                                        {{ translate('brand_&_model_&year') }}</th>
                                                            ...
                                                            <div class="media gap-3 align-items-center">
                                                                <div class="media-body">
                                                                    <a
                                                                        ...
                                                                        {{ $vehicle?->brand?->name }}
                                                                        - {{ $vehicle?->model?->name }} - {{$vehicle?->vehicleYear?->year}}
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class="viin-license">{{ $vehicle->licence_plate_number . $vehicle->licence_plate_char }}
                                                        </td>

<div class="col-12">
    <div class="">
        <ul class="nav d-inline-flex nav--tabs p-1 rounded bg-white">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.vehicle.attribute-setup.year.index') }}" class="{{ Request::is('admin/vehicle/attribute-setup/year*')?'nav-link active':'nav-link' }} text-capitalize">{{ translate('vehicle_year') }}</a>
            </li>
            <li class="nav-item">

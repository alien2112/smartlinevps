...
class LanguageManager {
  ...
  getLanguageInstruction(targetLang) {
    const instructions = {
      en: "You MUST respond ONLY in English. Do not mix languages. Do not use Arabic script. Do not use Arabizi.",
      ar: "You MUST respond ONLY in Arabic (Egyptian dialect). Do not mix languages. Do not use English words. Do not use Arabizi."
    };

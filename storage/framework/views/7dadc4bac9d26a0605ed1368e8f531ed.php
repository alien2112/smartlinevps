<?php $__env->startSection('title', 'Second Step'); ?>
    ...
    <div class="card mt-4">
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            ...
            <div class="d-flex align-items-center column-gap-3 flex-wrap">
                ...
                <h5 class="fw-normal"><?php echo e(translate('Update Purchase Information')); ?></h5>
            </div>
            <p class="mb-4"><?php echo e(translate('Provide your')); ?> <strong><?php echo e(translate('username')); ?> </strong> <?php echo e(translate('& the purchase code')); ?> </p>
                ...
                <div class="bg-light p-4 rounded mb-4">
                    ...
                    <div class="px-xl-2 pb-sm-3">
                        <div class="row gy-4">
                            <div class="col-md-6">
                                <div class="from-group">
                                    <label for="username" class="d-flex align-items-center gap-2 mb-2">
                                        <span class="fw-medium"><?php echo e(translate('Username')); ?></span>
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    <label for="purchase_key" class="mb-2"><?php echo e(translate('Purchase Code')); ?></label>
...
<?php echo $__env->make('installation.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\smartline-copy\smart-line.space\resources\views\installation\step2.blade.php ENDPATH**/ ?>
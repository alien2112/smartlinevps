...
<?php $__env->startSection('content'); ?>
    <div class="container pt-3">
        <section class="page-header bg__img"
            ...
            <h1 class="title"><?php echo e(translate('Privacy Policy')); ?></h1>
            <p class="mt-2">
...
<?php echo $__env->make('landing-page.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\smartline-copy\smart-line.space\resources\views\landing-page\privacy.blade.php ENDPATH**/ ?>
            ...
            <div class="card mt-3">
                <div class="card-body">
                    <div class="mar-ver pad-btm text-center mb-4">
                        ...
                        <?php if(env('SOFTWARE_VERSION') >= 1.4): ?>
                            <div class="alert alert-danger px-1 mt-2" role="alert">
                                <?php echo e(translate("Important Notice: We've upgraded the Firebase push notification system to a new and improved version as the old one will be phased out by June 2024.
                                ...
                                <a class="alert-link" target="_blank" href="https://docs.6amtech.com/docs-grofresh/admin-panel/mandatory-setup#firebase-configuration-for-notification"><?php echo e(translate('kindly follow the documentation')); ?></a>
                            </div>
                        <?php endif; ?>
                    </div>
...
<?php echo $__env->make('installation.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\smartline-copy\smart-line.space\resources\views\update\update-software.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'Third Step'); ?>
    ...
    <div class="card mt-4 position-relative">
        ...
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            <div class="d-flex align-items-center column-gap-3 flex-wrap">
                <h5 class="fw-bold fs text-uppercase"><?php echo e(translate('Step 5.')); ?> </h5>
                <h5 class="fw-normal"><?php echo e(translate('Admin Account Settings')); ?></h5>
            </div>
            <p class="mb-4"><?php echo e(translate('These information will be used to create')); ?> <strong><?php echo e(translate('super admin credential')); ?></strong>
                <?php echo e(translate('for your admin panel')); ?>.
            </p>
            ...
            <form method="POST" action="<?php echo e(route('system_settings',['token'=>bcrypt('step_6')])); ?>">
                        ...
                        <div class="row gy-4">
                            <div class="col-md-12">
                                <div class="from-group">
                                    <label for="first-name" class="d-flex align-items-center gap-2 mb-2"><?php echo e(translate('Business Name')); ?></label>
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    <label for="first-name" class="d-flex align-items-center gap-2 mb-2">
                                        <?php echo e(translate('First Name')); ?></label>
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    <label for="last-name" class="d-flex align-items-center gap-2 mb-2">
                                        <?php echo e(translate('Last Name')); ?></label>
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    <label for="phone" class="d-flex align-items-center gap-2 mb-2">
                                        <span class="fw-medium"><?php echo e(translate('Phone')); ?></span>
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    <label for="email" class="d-flex align-items-center gap-2 mb-2">
                                        <span class="fw-medium"><?php echo e(translate('Email')); ?></span>
                                        <span class="cursor-pointer" data-bs-toggle="tooltip"
                                              data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                                              data-bs-html="true"
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    <label for="password"
                                           class="d-flex align-items-center gap-2 mb-2"><?php echo e(translate('Password')); ?></label>
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    <label for="confirm-password" class="d-flex align-items-center gap-2 mb-2"><?php echo e(translate('Confirm Password')); ?></label>
                                    <div class="input-inner-end-ele position-relative input-group_tooltip">
                ...
                <div class="d-flex justify-content-center">
                    <button type="submit" class="btn btn-dark px-sm-5"><?php echo e(translate('Complete Installation')); ?></button>
                </div>
            </form>
        </div>
    </div>
...
<?php echo $__env->make('installation.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\smartline-copy\smart-line.space\resources\views\installation\step5.blade.php ENDPATH**/ ?>
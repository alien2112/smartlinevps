...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card mt-4">
        <div class="p-4 my-md-3 mx-xl-4 px-md-5">
            <p class="text-center mb-4 top-info-text"><?php echo e(translate('Before starting the installation process please collect this
            ...
            <div class="bg-light p-4 rounded mb-4">
                <div class="d-flex justify-content-between gap-1 align-items-center flex-wrap mb-4 pb-sm-3">
                    <h6 class="fw-bold text-uppercase fs m-0 letter-spacing"
                        style="--fs: 14px"><?php echo e(translate('Required Database Information')); ?>
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex gap-4 align-items-center flex-wrap">
                                <img
                                    ...
                                    alt="">
                                <div><?php echo e(translate('Database Name')); ?></div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="d-flex gap-4 align-items-center flex-wrap">
                                <img
                                    ...
                                    alt="">
                                <div><?php echo e(translate('Database Password')); ?></div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="d-flex gap-4 align-items-center flex-wrap">
                                <img
                                    ...
                                    alt="">
                                <div><?php echo e(translate('Database Username')); ?></div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="d-flex gap-4 align-items-center flex-wrap">
                                <img
                                    ...
                                    alt="">
                                <div><?php echo e(translate('Database Host Name')); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="text-center">
                <p><?php echo e(translate('Are you ready to start installation process')); ?> ?</p>

                <div class="d-flex justify-content-center">
                    <a href="<?php echo e(route('step1',['token'=>bcrypt('step_1')])); ?>" class="btn btn-dark px-sm-5">
                        <?php echo e(translate('Get Started')); ?></a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('installation.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\smartline-copy\smart-line.space\resources\views\installation\step0.blade.php ENDPATH**/ ?>
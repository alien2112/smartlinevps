<?php $__env->startSection('title', translate('update_Notification')); ?>
    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                ...
                <?php echo e(translate('push_notification_update')); ?>
                ...
                <form action="<?php echo e(route('admin.notification.update',[$notification['id']])); ?>" method="post"
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php echo e($notification['title']); ?>" name="title" class="form-control"
                                        placeholder="<?php echo e(translate('new_notification')); ?>" required>
                            </div>
                            ...
                            <div class="form-group">
                                        <label class="title-color text-capitalize"
                                               for="exampleFormControlInput1"><?php echo e(translate('product')); ?> </label>
                                        <select name="product" class="form-control" id="productSelect" required>
                                            <option value="" selected disabled><?php echo e($notification->product_slug); ?></option>
                        ...
                        <div class="col-md-6">
                            ...
                            <label class="title-color"><?php echo e(translate('image')); ?></label>
